...
{
public:
	Shader() : m_pointLightCount{ 0 }, m_shaderID{ 0 }, m_uniformProjection{ 0 }, m_uniformModel{ 0 }, m_uniformView{ 0 }, m_uniformPointLightCount{ 0 },
		m_uniformEyePosition{ 0 }, m_uniformSpecularIntensity{ 0 }, m_uniformShininess{ 0 }, m_uniformDirectionalLight{0, 0, 0, 0} {}
	~Shader();
